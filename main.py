...
def main():
    ...
    application.add_handler(MessageHandler(
        (filters.TEXT | filters.Caption.ALL) & ~filters.COMMAND & filters.ChatType.PRIVATE,
    ...
    application.add_handler(MessageHandler(
        (filters.TEXT | filters.Caption.ALL) & ~filters.COMMAND & (filters.ChatType.GROUP | filters.ChatType.SUPERGROUP),
